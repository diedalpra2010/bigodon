...
class ServicoController extends Controller
{
    ...
    {
        $servico = new Servico();
        $form = $this->createForm('BigodonBundle\Form\ServicoType', $servico);
        ...
        return $this->render('BigodonBundle:Servico:new.html.twig', array(
            'servico' => $servico,
    ...
    public function showAction(Servico $servico)
    {
        ...
        return $this->render('BigodonBundle:Servico:show.html.twig', array(
            'servico' => $servico,
    ...
    {
        $deleteForm = $this->createDeleteForm($servico);
        $editForm = $this->createForm('BigodonBundle\Form\ServicoType', $servico);
        ...
        return $this->render('BigodonBundle:Servico:edit.html.twig', array(
            'servico' => $servico,
