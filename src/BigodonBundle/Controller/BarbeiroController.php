...
use BigodonBundle\Entity\Barbeiro;
...
class BarbeiroController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $barbeiros = $em->getRepository('BigodonBundle:Barbeiro')->findAll();

        return $this->render('BigodonBundle:Barbeiro:index.html.twig', array(
            'barbeiros' => $barbeiros,
        ));
    }
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('BigodonBundle\Form\BarbeiroType', $barbeiro);
        ...
        return $this->render('BigodonBundle:Barbeiro:new.html.twig', array(
            'barbeiro' => $barbeiro,
    ...
    public function showAction(Barbeiro $barbeiro)
    {
        ...
        return $this->render('BigodonBundle:Barbeiro:show.html.twig', array(
            'barbeiro' => $barbeiro,
    ...
    {
        $deleteForm = $this->createDeleteForm($barbeiro);
        $editForm = $this->createForm('BigodonBundle\Form\BarbeiroType', $barbeiro);
        ...
        return $this->render('BigodonBundle:Barbeiro:edit.html.twig', array(
            'barbeiro' => $barbeiro,
